...
public class Manager extends Employee implements Trabajador {
    ...
    public void organizarReunion() {
        System.out.println("El manager " + this.getFullName() + " convoca a una reunión");
    }
    ...
    public void calcularSalario() {
        ...
        System.out.println("El salario del Manager " + this.getFullName() + " es de $" + salarioManager);
    }
    ...
    public String toString() {
        return "Manager [antiguedad=" + antiguedad + ", incremento=" + incremento + ", nombre="
                + getFullName() + ", id=" + getId() + ", salario=" + getSalario() + ", puesto="
                + getPuesto() + "]";
    }
