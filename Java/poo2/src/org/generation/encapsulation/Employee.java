...
public class Employee {
	// 1. Encapslar Atributos o Propiedades utilizando un modificador privado
	...
	// 2. Encapsular el Método Constructor. 
	public Employee(String nombre, String apellido, int id, String puesto, double salario) {
		this.nombre = nombre;
